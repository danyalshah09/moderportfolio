            ...
            >
              ...
              <div className="relative z-10">
                <div className="text-center mb-16">
                  <h2 ref={titleRef} className="text-4xl font-bold text-center mb-4 text-white drop-shadow-lg">
                    My Expertise
                  </h2>
                  <p
                    ref={subtitleRef}
                    className="text-lg text-stone-200 max-w-2xl mx-auto leading-relaxed drop-shadow-sm"
                  >
