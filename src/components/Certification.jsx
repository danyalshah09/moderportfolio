...
const Certifications = () => {
  ...
  return (
    <section id="certifications" className="py-12 sm:py-16 lg:py-20 bg-white dark:bg-black">
      <div className="container mx-auto px-4 sm:px-6">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl sm:text-4xl font-bold text-center mb-8 sm:mb-12 lg:mb-16 bg-gradient-to-r from-stone-600 to-stone-600 bg-clip-text text-transparent dark:text-white">
            Certifications
          </h2>
              ...
              >
                {certifications.map((cert, index) => (
                  <div key={index} className="w-full flex-shrink-0 px-2 sm:px-4">
                    <div className="bg-gray-50 dark:bg-stone-600 rounded-xl p-4 sm:p-6 lg:p-8 mx-auto max-w-md sm:max-w-lg lg:max-w-xl">
                      {/* Header */}
                      <div className="flex items-start justify-between mb-4 sm:mb-6">
                        <div className="flex items-center flex-1 min-w-0">
                          <div className="w-10 h-10 sm:w-12 sm:h-12 bg-stone-600 dark:bg-stone-900 rounded-full flex items-center justify-center mr-3 flex-shrink-0">
